...
const Footer = () => {
    return (
        <div className="text-[#d9d9d9] bg-[#323232] flex flex-col items-center gap-5 py-5 px-[8vw] pt-[80px] mt-28">
            <div className="w-full grid grid-cols-4 gap-20 [&>div]:flex [&>div]:flex-col [&>div]:items-start [&>div]:gap-5">
                <div className="col-span-2">
                    ...
                    <div className="[&>img]:w-10 [&>img]:mr-3.5 flex">
